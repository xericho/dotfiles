...
win_width_percent  = 50  ; set to 0 to disable
win_height_percent = 98  ; set to 0 to disable
...
win_topleft_x := -10 ;A_ScreenWidth * ((100 - win_width_percent)/2)/100 ; calculate the top left (x,y)
win_topleft_y := 0
...
TheHotKey: ; setup our hotkey
	...
	Else
	{
		Run, "C:\Users\erich\Windows Terminal (Preview) - Shortcut.lnk"
		WinWait, %win_title%
